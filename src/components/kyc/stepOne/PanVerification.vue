<template>
      ...
      <div class="lg:mt-8 w-full">
        ...
        <div class="mt-6">
          <div class="items-center gap-4 mb-2 w-full relative">
            <label for="full-name" class="block text-sm font-medium text-slate-500 mb-2">
          ...
          <div class="items-center gap-4 mb-2 w-full relative">
            <label for="pan" class="block text-sm font-medium text-slate-500 mb-2">PAN Number</label>
            <input
              v-model="localPan"
              type="text"
              id="pan"
          ...
          <div class="items-center gap-4 mb-2 w-full relative">
            <label for="dob" class="block text-sm font-medium text-slate-500 mb-2">Date Of Birth - (as per PAN)</label>
            <input
              v-model="localDob"
              type="date"
              id="dob"
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      watch(() => props.pan, (newValue) => {
        localPan.value = newValue;
      });
      watch(() => props.fullName, (newValue) => {
        localFullName.value = newValue;
      });
      watch(() => props.dob, (newValue) => {
