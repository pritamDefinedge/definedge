  ...
  <div class="w-full lg:w-10/12 mx-auto mb-8">
    ...
    <div class="lg:mt-8 w-full">
      ...
      <div class="mt-6">
        ...
        <p
          v-if="cameraError"
          class="text-red-500 flex justify-center items-center flex-col border-2 rounded-lg p-4"
        >
          <textarea
            id="message"
            rows="4"
            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Camera error: Unable to detect your signature."
          ></textarea>
        </p>
        ...
        <div v-if="!cameraError" class="text-left mt-6">
          ...
          <button
            class="bg-white text-black px-4 py-2 border-2 border-black rounded-md shadow-md transition duration-300"
          >
            Refresh
          </button>
          <div class="text-sm font-medium text-slate-600 mt-4">OR</div>
          <div class="text-sm font-normal text-slate-600 mt-4">
            Please sign on a blank piece of paper with a pen and upload a photo
            of it. Signatures made with pencils, markers, or other tools are not
            accepted.
          </div>
        </div>
