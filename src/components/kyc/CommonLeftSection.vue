<template>
  <section class="lg:col-span-4">
    ...
    >
      <div class="flex justify-between items-center">
        <img
          ...
          src="../../assets/definedge-light-logo.png"
          alt="definedge"
        />
    ...
    >
      <div class="flex justify-between items-center">
        <img
          class="h-10 lg:h-9 w-auto"
          src="../../assets/definedge-light-logo.png"
          alt="definedge"
        />
        <img
          class="h-10 lg:h-9 w-auto block lg:hidden"
          src="https://signup.definedgesecurities.com/assets/close-white-icon-16c4318d.svg"
          alt="definedge"
        />
      </div>
        ...
        >
          ...
          <li class="mb-10 ms-6">
            ...
            <p class="text-sm text-gray-300">
              Segment, Photo, Signature, Nominee
            </p>
          </li>
          <li class="mb-10 ms-6">
            <span
            ...
            <p class="text-sm text-gray-300">
              Saving Account, IFSC Code, Upload DOC
            </p>
          </li>
          <li class="ms-6">
            <span
            ...
            <p class="text-sm text-gray-300">Verify Info, E-sign</p>
          </li>
        </ol>
      </nav>
      <div class="mt-12 relative">
        ...
        <div
          class="voltage-line absolute bottom-0 left-10 h-[10px] overflow-hidden justify-center items-center"
        ...
        >
          ...
          >
            ...
            <path
              class="glow [stroke-width:8px] origin-center animate-wave-move wave-1 opacity-90"
            ...
            />
            <path
              class="glow [stroke-width:8px] origin-center animate-wave-move wave-2 opacity-70"
          ...
          >
            <div
              class="dot-1 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[0%] animate-move-on-wave-1"
            ></div>
            <div
              class="dot-2 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[5%] animate-move-on-wave-2"
            ></div>
            <div
              class="dot-3 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[10%] animate-move-on-wave-3"
            ></div>
            <div
              class="dot-4 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[15%] animate-move-on-wave-4"
            ></div>
            <div
              class="dot-5 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[20%] animate-move-on-wave-5"
            ></div>
            <div
              class="dot-6 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[25%] animate-move-on-wave-6"
            ></div>
            <div
              class="dot-7 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[80%] animate-move-on-wave-7"
            ></div>
            <div
              class="dot-8 absolute w-[4px] h-[4px] top-[4px] rounded-full bg-[#4facfe] [box-shadow:0_0_15px_#4facfe,0_0_25px_#4facfe,0_0_35px_#4facfe,0_0_45px_#4facfe] opacity-0 origin-center left-[100%] animate-move-on-wave-8"
            ></div>
          </div>
        </div>
      </div>
