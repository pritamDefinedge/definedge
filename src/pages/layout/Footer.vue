<template>
  <footer class="bg-black py-12 px-10 font-sans">
    <div class="container mx-auto px-6">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full sm:w-1/2 lg:w-1/4">
          <h4 class="text-white font-semibold text-xl mb-6">
        ...
        <!-- Registered Address -->
        <div class="w-full sm:w-1/2 lg:w-1/4">
          <h4 class="text-white font-semibold mb-6">Registered Address</h4>
          <ul class="space-y-3">
            <li>
              <a
                class="text-gray-200 hover:text-white"
            ...
            <li>
              <a
                href="javascript:void(0)"
                class="text-gray-200 text-xl font-extrabold hover:text-white"
                >Corporate office</a
              >
            </li>
            <li>
          ...
          <ul class="space-y-3">
            ...
            <li>
              <a
                href="javascript:void(0)"
                class="text-gray-200 hover:text-white"
                >Marketo Integration Services</a
              >
            </li>
            <li>
              <a
